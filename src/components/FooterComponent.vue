...
<template>
  <div class="position-fixed bottom-0 left-0 w-full border-t bg-white p-4 text-lg">
    <div>
      ...
      <div class="mt-5 flex items-center justify-center border border-blue rounded-xl p-2 p-4 text-blue">
