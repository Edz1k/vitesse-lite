...
<template>
  <div v-if="visible" class="fade-in-out absolute top-10 z-24 w-full p-4">
...
@keyframes fadeInOut {
  ...
  20% {
    opacity: 1; /* Появление: прозрачность 1 */
  }
  80% {
    opacity: 1; /* Длительное отображение */
  }
  100% {
    opacity: 0; /* Исчезновение: прозрачность 0 */
  }
}
